...
func (e *JavascriptScriptingEngine) RunCode(ctx *fctx.FragsContext, code string, params any, runner frags.ExportableRunner) (any, error) {
	innerCtx := fctx.WithFragsContext(ctx, 1*time.Minute)
