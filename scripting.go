...
import "github.com/theirish81/frags/fctx"
...
type ScriptEngine interface {
	RunCode(ctx *fctx.FragsContext, code string, params any, runner ExportableRunner) (any, error)
}

type DummyScriptEngine struct{}

func (d *DummyScriptEngine) RunCode(_ *fctx.FragsContext, _ string, _ any, _ ExportableRunner) (any, error) {
